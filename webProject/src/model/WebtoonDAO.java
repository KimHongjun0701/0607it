...
public class WebtoonDAO {
	...
	final String sql_insert = "INSERT INTO WEBTOON(WID,TITLE,IMG,AUTHOR) VALUES((SELECT NVL(MAX(WID),0)+1 FROM WEBTOON),?,?,?)";
	...
	final String sql_selectLike = "SELECT * FROM WEBTOON WHERE TITLE LIKE '%'||?||'%' ORDER BY CNT DESC ";
