...
public class RecentViewDAO {
	...
	final String sql_Insert = "INSERT INTO RECENTVIEW VALUES((SELECT NVL(MAX(RPK),0)+1 FROM RECENTVIEW),?,?)";
	...
	final String sql_Delete = "DELETE FROM RECENTVIEW WHERE RPK=(SELECT MIN(RPK) FROM RECENTVIEW WHERE PPK = ?)";
